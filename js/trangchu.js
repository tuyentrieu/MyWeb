...
window.onload = function() {
    ...
    var tags = ["Samsung", "iPhone", "Coolpad", "Oppo"];
...
function hienThiKhungSanPhamMacDinh() {
    ...
    addKhungSanPham('Bán Chạy Nhất', yellow_red, ['star=0', 'sort=SoDanhGia-desc', 'page=0'], soLuong);
    ...
    addKhungSanPham('Gía Sốc ONLINE', green, ['promo=giareonline', 'page=0'], soLuong);
    addKhungSanPham('Giảm giá ', yellow_red, ['promo=giamgia', 'page=0'], soLuong);
    addKhungSanPham('Giá rẻ', green, ['price=0-3000000', 'sort=DonGia-asc', 'page=0'], soLuong);
}
