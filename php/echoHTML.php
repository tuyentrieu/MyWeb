...
function addHeader()
{
	...
	<div class="header group">
        ...
        <div class="logo">
            <a href="index.php">
                <img src="img/brand01.png" alt="P" title="">
            </a>
        </div> <!-- End Logo -->
            ...
            <div class="search-header">
                <form class="input-search" method="get" action="index.php">
                    <div class="autocomplete">
                        <input id="search-box" name="search" autocomplete="off" type="text" placeholder="">
                        <button type="submit">
...
function addFooter()
{
    ...
    <div class="copy-right">
        <p>
        Hanoi University of Mining and Geology '  . ' - Designed by
            <span style="color: #eee; font-weight: bold">SOULIYA_SHOP</span>
        </p>
    </div>';
}
        ...
        <section>
            <ul class="flexContain">
                ...
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:092275713" style="color: #288ad6;">0922.75713</a>
                </li>
            </ul>
        </section>
    </div>';
